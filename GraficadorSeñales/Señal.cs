...
namespace GraficadorSeñales
{
    abstract class Señal
    {
        ...
        public static Señal promedio(Señal señal1, Señal señal2)
        {
            SeñalResultante resultado = new SeñalResultante();
            ...
            foreach (var muestra in señal1.Muestras)
            {
                double nuevoValor = (muestra.X + señal2.Muestras[indice].X) / 2;
                resultado.Muestras.Add(new Muestra(nuevoValor, muestra.Y));
